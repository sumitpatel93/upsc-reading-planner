...
export default function PaymentSuccess() {
  ...
  useEffect(() => {
    ...
    const paymentStatus = params.get('order_status') || params.get('payment_status') || 'SUCCESS'
      ...
      <div style={{ background:'white', borderRadius:20, padding:'48px 40px', maxWidth:420, width:'100%', textAlign:'center', boxShadow:'0 8px 32px rgba(0,0,0,0.1)' }}>
        ...
        {status === 'failed' && (
          <>
            ...
            <div style={{ fontSize:14, color:'#64748b', marginBottom:24 }}>Something went wrong. Your payment was not confirmed. If money was deducted, it will be refunded in 5-7 days.</div>
            <button
              onClick={() => router.push('/pdf')}
